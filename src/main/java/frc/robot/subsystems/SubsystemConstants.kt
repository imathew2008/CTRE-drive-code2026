...
object ShooterConstants {
    ...
    //32:124 = 8:31
    //68:13
    const val TURRET_PRIMARY_TO_MECHANISM_RATIO = (124.0 / 32.0) * (5.0 /1.0)
    const val TURRET_ABSOLUTE_TO_MECHANISM_RATIO = 1.0 / ((44.0/210.0) * (68.0 /13.0))
...
//    const val HOOD_GEAR_RATIO = 16.0 / 27.0 / 15.0 / 164.0
    const val HOOD_GEAR_RATIO = (27.0/16.0) * (164.0/15.0) * (1/360.0)
//    const val HOOD_MIN_ROT  = 0.0
//    const val HOOD_MAX_ROT  = 0.18
    const val HOOD_HOME_ROT = 0.00
    const val HOOD_MIN_ROT = 0.0
    const val HOOD_MAX_ROT = 30.0

    const val HOOD_kP = 25.0
    const val HOOD_kI = 0.0
    const val HOOD_kD = 0.0
    const val HOOD_kS = 0.0
    const val HOOD_kV = 0.0
    const val HOOD_kA = 0.0
    const val HOOD_kG = 0.1

    const val HOOD_CRUISE_VEL = 180.0
    const val HOOD_ACCEL = 360.0
    ...
    // Flywheels
    // -------------------------
    const val FLYWHEEL_kS = 0.4
    const val FLYWHEEL_kV = 0.154
    const val FLYWHEEL_kA = 0.0
    const val FLYWHEEL_kP = 10.0
